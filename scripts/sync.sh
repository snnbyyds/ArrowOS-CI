...
git clone -b arrow-13.0 https://github.com/SevralT/device_oneplus_fajita.git device/oneplus/fajita
ls device/oneplus/fajita
rm -rf device/oneplus/sdm845-common
git clone -b arrow-13.0 https://github.com/SevralT/device_oneplus_sdm845-common.git device/oneplus/sdm845-common
...
git clone --depth=1 -b lineage-20 https://github.com/LineageOS/android_kernel_oneplus_sdm845.git kernel/oneplus/sdm845
...
git clone -b arrow-13.0 https://github.com/ArrowOS-Devices/android_hardware_oneplus.git hardware/oneplus
